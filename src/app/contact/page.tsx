      ...
      <section className="max-w-5xl mx-auto px-4">
        <div className="flex flex-col items-center mb-10">
          <span className="flex items-center border border-gray-200 text-black text-sm font-medium px-4 py-1 rounded-full">
            ...
            Contact Us
          </span>            <h1 className="text-3xl md:text-5xl lg:text-6xl font-medium text-center mb-2 mt-4 text-black">Contact Us to Start<br />Your Transformation</h1>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Center: Form */}
          <form className="bg-white border border-gray-200 rounded-xl  px-4 py-5 flex flex-col gap-2 col-span-2 md:col-span-1">
      ...
      <section className="max-w-5xl mx-auto px-4 mt-20">
        <div className="flex flex-col items-center mb-10">
          <span className=" flex items-center border border-gray-200 text-black text-sm font-medium px-4 py-1 rounded-full">
            <Image src="/icon.svg" alt="Logo" width={32} height={32} />
            Office
          </span>           <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-center">Come and Visit us!</h2>
        </div>
